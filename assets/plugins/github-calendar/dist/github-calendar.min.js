...
! function(e) {
    ...
    return function e(t, n, r) {
            ...
            t.exports = function(e, t, c) {
                ...
                var i = function l() {
                    return fetch(c.proxy("https://github.com/" + t)).then(function(e) {
                        ...
                        i.innerHTML = t;
                        var f = i.querySelector("#contributions-calendar");
                        if (f.querySelector(".float-left.text-gray").innerHTML = c.summary_text, f.querySelector("include-fragment")) setTimeout(l, 500);
                            ...
                            if (c.global_stats !== !1) {
                                ...
                                f.appendChild(m), f.appendChild(y), f.appendChild(b)
                            }
        ...
        3: [function(e, t) {
            t.exports = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], t.exports.abbr = ["Sun", "Mon", "Tue", "Wed", "Thur", "Fri", "Sat"], t.exports["short"] = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"]
        }, {}],
        4: [function(e, t) {
            function n(e, t) {
